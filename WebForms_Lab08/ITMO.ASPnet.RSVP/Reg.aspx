<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reg.aspx.cs" Inherits="ITMO.ASPnet.RSVP.Reg" MasterPageFile ="~/Site.master" UnobtrusiveValidationMode="None" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div> 
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="name" ErrorMessage="Заполните поле имени" ForeColor="Red" Display="Dynamic">Не оставляйте поле пустым</asp:RequiredFieldValidator>
        </div> 
        <div> 
            <label>Ваш email:</label><asp:TextBox ID="email" runat="server"></asp:TextBox> 
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="email" ErrorMessage="Заполните поле адреса" ForeColor="Red" Display="Dynamic">Не оставляйте поле пустым</asp:RequiredFieldValidator>
        ...
        <div> 
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="phone" ErrorMessage="Заполните поле ввода телефона" ForeColor="Red" Display="Dynamic">Не оставляйте поле пустым</asp:RequiredFieldValidator>
        </div> 
        <div> 
